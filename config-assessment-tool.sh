...
case "$1" in
  ...
  *)
    echo "Usage:"
    echo "  config-assessment-tool --start                # Starts CAT UI. Requires Python 3.12 and pipenv installed.  UI accessible at http://localhost:8501"
    echo "  config-assessment-tool --start [args]         # Starts CAT headless mode from source with [args].  Requires Python 3.12 & pipenv installed."
    echo "  config-assessment-tool --start docker         # Starts CAT UI using Docker. requires Docker. UI accessible at http://localhost:8501"
    echo "  config-assessment-tool --start docker [args]  # Starts CAT headless mode using Docker with [args]. Requires Docker installed."
    echo "  config-assessment-tool --plugin <list|start|docs> [name]    # list plugins | start plugin | show docs for plugin"
